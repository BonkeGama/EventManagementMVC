...
namespace OlwandleHotel.Controllers
{
    ...
    public class Reservations1Controller : Controller
    {
        ...
        {          
            ...
            if (MemberMail == null)
            {
                ModelState.AddModelError("", "You must be logged in to make a Rental");
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    TempData["res"] = "Start Date can't come after End Date";
                ...
                {
                    reservation.status = "Hired";
                    myroom.RoomStatus = "Hired";
                    db.SaveChanges();
                }
                ...
                if (reservation.roomChecker(reservation.checkInDate)==true)
                {
                    if (reservation.CheckRoomGuests(reservation.numGuests) == true)
                    {
                        ...
                        try
                        {
                            ...
                            myMessage.AddTo("tbosba@gmail.com"/*User.Identity.Name*/);
                            string subject = "Hiring Successful";
                            string body = ("Dear "  + User.Identity.Name + "<b/r>" +
                                 " " + "We would like to inform you that your Tent Rental at Durban Equipment Hire is successful.. please see below the details of your Rental." + "<b/r>" + " " + " Date : " + reservation.DateBooked + "<b/r>" + "Tent Number: " + " " + reservation.RoomNo + "<b/r>" + " " + "Number of Days: " + " " + reservation.numGuests + "<b/r>" + " " + "Total Price: " + " " + reservation.TotalPrice);
                    ...
                    else
                    {
                        ...
                        {
                            ModelState.AddModelError("", "The Tent cannot be hired for more than "+ reservation.numGuests);
                        }
                    }
                }
                else
                {
                    ModelState.AddModelError("", "The tent is already hired please hire another one or hire a date later than " + reservation.outDate());
                }
        ...
        public ActionResult PayFast()
        {
            ...
            str.Append("&item_description=" + HttpUtility.UrlEncode(description));
                ...
                // Redirect to PayFast
                TempData["payment"] = "Payment for Hiring was successful";
        ...
        public ActionResult Delete(int? id)
        {
            ...
            {
                ModelState.AddModelError("", "You cannot cancel this rental because the day of rental has already started ");
